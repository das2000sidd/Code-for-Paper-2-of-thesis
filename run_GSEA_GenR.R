...
greenspace=read.csv(file="GenR_M3_greenyn300_glmFit_18787.csv",header=T,sep=" ",stringsAsFactors = F)
ndvi100=read.csv(file="GenR_M3_ndvi100_glmFit_18787.csv",header=T,sep=" ",stringsAsFactors = F)
ndvi200=read.csv(file="GenR_M3_ndvi300_glmFit_18787.csv",header=T,sep=" ",stringsAsFactors = F)
ndvi300=read.csv(file="GenR_M3_ndvi500_glmFit_18787.csv",header=T,sep=" ",stringsAsFactors = F)
